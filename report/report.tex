...
chirp (arriba), con zoom a 3 Hz donde se resuelven las franjas de
interferencia individuales de las dos im\'agenes (medio), y su fase en ese
mismo zoom (abajo). $w$ va de 62 (inicio de banda) a 778 (merger) ac\'a ---
por encima de \code{w\_geo\_threshold=30}, as\'i que cada valor de $F$ acá
YA es la f\'ormula de \'optica geom\'etrica de dos im\'agenes
(\code{theory/theory.pdf} Cap.~3), no la integral de difracci\'on exacta
--- confirmado reconstruyendo \code{h\_lensado} a partir de nada m\'as que
dos copias retrasadas y reescaladas de la forma de onda no lensada:
acuerdo con la salida real de \code{run.py} a $1.1\times10^{-13}$,
precisi\'on de m\'aquina. Las franjas son la interferencia entre esas dos
im\'agenes, no un efecto de difracci\'on adicional (ese es el r\'egimen del
Caso~B, m\'as abajo).}
\end{figure}
